...
class Pustaka : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val imageViewPindah = findViewById<TextView>(R.id.btn_kembalikan) // Ganti dengan ID ImageView Anda

        imageViewPindah.setOnClickListener {
            val intent = Intent(this, dikembalikan::class.java)
            startActivity(intent)
        }
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.dibaca)) { v, insets ->
